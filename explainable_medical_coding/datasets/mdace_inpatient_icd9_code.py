...
_URL = REPOSITORY_PATH / "data" / "processed" / "mdace_icd9_inpatient_code"
_URLS = {
...
class MDACE_Inpatient_ICD9_Code_Config(datasets.BuilderConfig):
    """BuilderConfig for MDACE-Inpatient-ICD9-Code."""
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(MDACE_Inpatient_ICD9_Code_Config, self).__init__(**kwargs)


class MDACE_Inpatient_ICD9_Code(datasets.GeneratorBasedBuilder):
    """MDACE-Inpatient-ICD9-Code: A public medical coding subset of MIMIC-III cleaned with evidence spans with ICD-9 diagnosis and procedure codes Version 1.0"""

    BUILDER_CONFIGS = [
        MDACE_Inpatient_ICD9_Code_Config(
