...
class MDACE_Inpatient_ICD10_Config(datasets.BuilderConfig):
    """BuilderConfig for MDACE-Inpatient-ICD10."""
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(MDACE_Inpatient_ICD10_Config, self).__init__(**kwargs)


class MDACE_Inpatient_ICD10(datasets.GeneratorBasedBuilder):
    """MDACE-Inpatient-ICD10: A public medical coding subset of MIMIC-III cleaned with evidence spans with ICD-10 diagnosis and procedure codes Version 1.0"""

    BUILDER_CONFIGS = [
        MDACE_Inpatient_ICD10_Config(
            name="mdace_inpatient_icd10",
